...
class Event(models.Model):
    ...
    x_invitados_proyectados = fields.Integer(string="Invitados proyectados")
    ...
    x_fecha_de_solicitud = fields.Datetime(string="Fecha de solicitud", related='x_solicitud_de_evento.x_fecha_de_solicitud')

    x_hora_de_registro = fields.Float(string="Hora registro")
    x_hora_inicio_del_evento = fields.Float(string="Hora inicio")
    x_hora_fin_del_evento = fields.Float(string="Hora fin")
    x_hora_maxima_de_salida = fields.Float(string="Hora salida")
    ...
    #         self.x_hora_maxima_de_salida = self.date_end
    ...
    #         self.x_hora_maxima_de_salida = hora_de_salida
    #         self.x_duracion_del_evento = (evento_en_horas, 2)
    #
    # @api.onchange('x_hora_de_registro', 'x_hora_maxima_de_salida')
    # def _hora_de_duracion(self):
    #
    #     if self.x_hora_de_registro and self.x_hora_maxima_de_salida:
